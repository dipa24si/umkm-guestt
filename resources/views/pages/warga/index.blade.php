            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="{{route('warga.index')}}" class="nav-item nav-link {{ request()->routeIs('dashboard') ? 'active' : ''}}">Warga</a>
                        <a href="menu.html" class="nav-item nav-link {{ request()->routeIs('dashboard') ? 'active' : ''}}">Menu</a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="card shadow-sm border-0 rounded-4">
                        <div class="card-body text-center p-4">
                            ...
                            @if($item->email)
                                <p class="small text-secondary mb-2"><i class="fa fa-envelope"></i> {{ $item->email }}</p>
                            @endif
                            @if($item->telp)
                                <p class="small text-secondary mb-3"><i class="fa fa-phone"></i> {{ $item->telp }}</p>
                            @endif
                            ...
                            <form action="{{ route('warga.destroy', $item->warga_id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus warga ini?')">Hapus</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<!-- Warga Section End -->
    ...
    <script src="{{ asset('assets/guest/https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js')}}"></script>
